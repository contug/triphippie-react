 ...
 */
export default function Loader({staticLoadingStatus = false}: LoaderProps) {

    const loadingStatus = staticLoadingStatus ? true : useSelector((state: RootState) => state.loading.globalLoadingStatus);
    return (
        <>
            {loadingStatus && (
                <>
